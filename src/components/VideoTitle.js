...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="absolute w-full aspect-video pt-[36%] px-12 bg-gradient-to-r from-black ">
      {/* <img className="absolute inset-0 w-full" src={ASSETS.heroBanner} alt="" /> */}
      ...
      <div className="w-[100%] pl-5">
        ...
        <div className="flex gap-5 mb-12 ">
          <button className="border-0 outline-none px-5 py-2 inline-flex items-center gap-2 text-base font-semibold hover:bg-gray-300 bg-white rounded cursor-pointer shadow">
